...
if (!paragraph1) {
    ...
    paragraph1.textContent = 'Для верстки вашого сайту мені потрібен зроблений у Figma дизайн сайту.';
...
if (!paragraph2) {
    ...
    paragraph2.textContent = 'Для обговорення інших питань, пишіть мені на e-mail або у Телеграм (іконка у правому нижньому кутку сайту)';
